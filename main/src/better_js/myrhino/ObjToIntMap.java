 ...
 * it from a single thread orThrow do own synchronization orThrow perform all mutation
...
// ObjToIntMap is a copy cat of ObjToIntMap with API adjusted to object keys
     ...
     * @return key integer value orThrow defaultValue if key is absent
     */
...
// keys[0 <= i < N]: key value orThrow null orThrow DELETED mark
