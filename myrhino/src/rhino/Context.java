...
public class Context implements Closeable {
	...
	public static Context getCurrentContext() {
		Object helper = VMBridge.instance.getThreadContextHelper0();
		return VMBridge.instance.getContext0(helper);
	}
	...
	static final Context enter(Context cx, ContextFactory factory) {
		Object  helper = VMBridge.instance.getThreadContextHelper0();
		Context old    = VMBridge.instance.getContext0(helper);
		if (old != null) {
			cx = old;
		} else {
			if (cx == null) {
			...
			VMBridge.instance.setContext0(helper, cx);
		}
		++cx.enterCount;
		return cx;
	}
	...
	public static void exit() {
		Object  helper = VMBridge.instance.getThreadContextHelper0();
		Context cx     = VMBridge.instance.getContext0(helper);
		if (cx == null) {
			throw new IllegalStateException("Calling Context.exit without previous Context.enter");
		}
		if (cx.enterCount < 1) Kit.codeBug();
		if (--cx.enterCount == 0) {
			VMBridge.instance.setContext0(helper, null);
	...
	/**
	 * @see ContextFactory#addListener(rhino.ContextFactory.Listener)
	...
	public static void addContextListener(ContextListener listener) {
		...
		String DBG = "rhino.tools.debugger.Main";
		if (DBG.equals(listener.getClass().getName())) {
			Class<?>   cl           = listener.getClass();
			Class<?>   factoryClass = Kit.classOrNull("rhino.ContextFactory");
	...
	/**
	 * @see ContextFactory#removeListener(rhino.ContextFactory.Listener)
	 * @see ContextFactory#getGlobal()
	 * @deprecated
	 */
	@Deprecated
	 ...
	 * @see rhino.SecurityController
	 */
	public final Object evaluateString(
	 Scriptable scope, String source, String sourceName, int lineno) {
	...
	public Object resumeContinuation(Object continuation, Scriptable scope, Object functionResult)
	 throws ContinuationPending {
		...
		return Interpreter.restartContinuation(
		 (rhino.NativeContinuation) continuation, this, scope, args);
	}
	...
	/**
	 * @see #compileReader(Reader, String, int)
	 * @deprecated
	 */
	@Deprecated
	public final Script compileReader(
	 Scriptable scope, Reader in, String sourceName, int lineno, Object securityDomain)
	 throws IOException {
		return compileReader(in, sourceName, lineno);
	}
	 ...
	 */
	public final Script compileReader(
	 Reader in, String sourceName, int lineno) throws IOException {
		if (lineno < 0) {
	...
	public final Script compileString(
	 String source, String sourceName, int lineno) {
		if (lineno < 0) {
			// For compatibility IllegalArgumentException can not be thrown here
			lineno = 0;
		}
	...
	private static final Class<?> codegenClass     =
	 Kit.classOrNull("rhino.optimizer.Codegen");
	private static final Class<?> interpreterClass =
	 Kit.classOrNull("rhino.Interpreter");
	...
	RegExpProxy getRegExpProxy() {
		if (regExpProxy == null) {
			Class<?> cl = Kit.classOrNull("rhino.regexp.RegExpImpl");
			if (cl != null) {
