...
public class ContextFactory {
	...
	/**
	 * Provides a default {@link rhino.xml.XMLLib.Factory XMLLib.Factory} to be
	 ...
	 */
	protected rhino.xml.XMLLib.Factory getE4xImplementationFactory() {
		...
		if (isDom3Present()) {
			return rhino.xml.XMLLib.Factory.create(
			 "rhino.xmlimpl.XMLLibImpl");
		}
		return null;
	}
	...
	protected GeneratedClassLoader createClassLoader(final ClassLoader parent) {
		return doPrivileged(() -> new DefiningClassLoader(parent));
	}
