...
/**
 * Exception thrown by {@link rhino.Context#executeScriptWithContinuations(Script,
 * Scriptable)} and {@link rhino.Context#callFunctionWithContinuations(Callable,
 * Scriptable, Object[])} when execution encounters a continuation captured by {@link
 * rhino.Context#captureContinuation()}. Exception will contain the captured state
 * needed to restart the continuation with {@link
 * rhino.Context#resumeContinuation(Object, Scriptable, Object)}.
 *
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * rhino.Context#executeScriptWithContinuations(Script, Scriptable)} and {@link
     * rhino.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
