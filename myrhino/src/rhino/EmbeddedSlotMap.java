...
public class EmbeddedSlotMap implements SlotMap {
    ...
    private ScriptableObject.Slot createSlot(Object key, int indexOrHash, int attributes) {
        if (count == 0) {
        ...
        ScriptableObject.Slot newSlot = new ScriptableObject.Slot(key, indexOrHash, attributes);
    ...
    public void replace(ScriptableObject.Slot oldSlot, ScriptableObject.Slot newSlot) {
        ...
        ScriptableObject.Slot tmpSlot   = prev;
