...
public class HashSlotMap implements SlotMap {
    ...
    @Override
    public ScriptableObject.Slot modify(Object key, int index, int attributes) {
        Object                name = makeKey(key, index);
    ...
    @Override
    public void replace(ScriptableObject.Slot oldSlot, ScriptableObject.Slot newSlot) {
        Object name = makeKey(oldSlot);
        map.put(name, newSlot);
    }

    private ScriptableObject.Slot createSlot(Object key, int index, int attributes) {
        ScriptableObject.Slot newSlot = new ScriptableObject.Slot(key, index, attributes);
        add(newSlot);
        return newSlot;
    }

    @Override
    public void add(ScriptableObject.Slot newSlot) {
    ...
    private Object makeKey(ScriptableObject.Slot slot) {
