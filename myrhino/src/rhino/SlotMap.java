...
public interface SlotMap extends Iterable<ScriptableObject.Slot> {
     ...
     */
    ScriptableObject.Slot modify(Object key, int index, int attributes);
    ...
    void replace(ScriptableObject.Slot oldSlot, ScriptableObject.Slot newSlot);
     ...
     */
    void add(ScriptableObject.Slot newSlot);
