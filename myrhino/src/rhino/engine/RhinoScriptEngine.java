 ...
 *       as 200.
 *   <li>rhino.optimization_level: The level of optimization Rhino performs on the
...
public class RhinoScriptEngine extends AbstractScriptEngine implements Compilable, Invocable {
     ...
     */
    public static final String OPTIMIZATION_LEVEL = "rhino.optimization_level";
    ...
    public Object eval(String script, ScriptContext context) throws ScriptException {
        try (Context cx = ctxFactory.enterContext()) {
            ...
            Object ret = cx.evaluateString(scope, script, getFilename(), 0);
    ...
    public CompiledScript compile(String script) throws ScriptException {
        try (Context cx = ctxFactory.enterContext()) {
            configureContext(cx);
            Script s = cx.compileString(script, getFilename(), 1);
    ...
    public CompiledScript compile(Reader script) throws ScriptException {
        try (Context cx = ctxFactory.enterContext()) {
            configureContext(cx);
            Script s = cx.compileReader(script, getFilename(), 1);
            return new RhinoCompiledScript(this, s);
        } catch (RhinoException re) {
            throw new ScriptException(
                    re.getMessage(), re.sourceName(), re.lineNumber(), re.columnNumber());
