...
public class VMBridge_jdk18 extends VMBridge {
	...
	@Override
	protected Context getContext0(Object contextHelper) {
		Object[] storage = (Object[]) contextHelper;
		return (Context) storage[0];
	}

	@Override
	protected void setContext0(Object contextHelper, Context cx) {
		Object[] storage = (Object[]) contextHelper;
		storage[0] = cx;
	}
	...
	@Override
	protected Object getInterfaceProxyHelper0(ContextFactory cf, Class<?>[] interfaces) {
