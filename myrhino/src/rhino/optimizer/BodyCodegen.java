...
class BodyCodegen {
	...
	private void generateActivationExit() {
		...
		cfw.addALoad(contextLocal);
		addScriptRuntimeInvoke("exitActivationFunction", "(Lrhino/Context;)V");
	}
	...
	private void generateThrowJavaScriptException() {
		cfw.add(ByteCode.NEW, "rhino/JavaScriptException");
	...
	private void generateExpression(Node node, Node parent) {
		...
		switch (type) {
			...
			case Token.NAME: {
				cfw.addALoad(contextLocal);
				cfw.addALoad(variableObjectLocal);
				last_token_name = node.getString();
				cfw.addPush(last_token_name);
				addScriptRuntimeInvoke(
				 "name",
				 "(Lrhino/Context;"
				 + "Lrhino/Scriptable;"
			...
			case Token.ADD: {
				...
				switch (node.getIntProp(Node.ISNUMBER_PROP, -1)) {
					...
					case Node.LEFT -> {
						...
						addOptRuntimeInvoke(
						 "add",
						 "(DLjava/lang/Object;Lrhino/Context;)Ljava/lang/Object;");
					}
					case Node.RIGHT -> {
						cfw.addALoad(contextLocal);
						addOptRuntimeInvoke(
						 "add",
						 "(Ljava/lang/Object;DLrhino/Context;)Ljava/lang/Object;");
					}
					default -> {
						cfw.addALoad(contextLocal);
						addScriptRuntimeInvoke(
	...
	private void generateYieldPoint(Node node, boolean exprContext) {
		if (unnestedYields.containsKey(node)) {
			...
			if (exprContext) {
				...
				addScriptRuntimeInvoke(
				 "getObjectPropNoWarn",
				 "(Ljava/lang/Object;Ljava/lang/String;Lrhino/Context;"
		...
		if (nestedYield != null) {
			...
			addScriptRuntimeInvoke(
			 "setObjectProp",
			 "(Lrhino/Scriptable;Ljava/lang/String;Ljava/lang/Object;"
			 + "Lrhino/Context;)Ljava/lang/Object;");
			cfw.add(ByteCode.POP);
	...
	private void generateLocalYieldPoint(Node node, boolean exprContext) {
		...
		if (node.getType() == Token.YIELD_STAR) {
			...
			cfw.add(ByteCode.NEW, "rhino/ES6Generator$YieldStarResult");
			cfw.add(ByteCode.DUP_X1);
			cfw.add(ByteCode.SWAP);
			cfw.addInvoke(
			 ByteCode.INVOKESPECIAL,
			 "rhino/ES6Generator$YieldStarResult",
			 "<init>",
			 "(Ljava/lang/Object;)V");
		}
	...
	private void generateFunctionAndThisObj(Node node, Node parent) {
		...
		addScriptRuntimeInvoke(
		 ...
		 "(Lrhino/Context;" + ")Lrhino/Scriptable;");
	}
	...
	private void addInstructionCount(int count) {
		cfw.addALoad(contextLocal);
		cfw.addPush(count);
		addScriptRuntimeInvoke("addInstructionCount", "(Lrhino/Context;" + "I)V");
	}
	...
	private void visitDotQuery(Node node, Node child) {
		...
		addScriptRuntimeInvoke(
		 "updateDotQuery",
		 "(Z" + "Lrhino/Scriptable;" + ")Ljava/lang/Object;");
		cfw.add(ByteCode.DUP);
		...
		addScriptRuntimeInvoke(
		 "leaveDotQuery",
		 "(Lrhino/Scriptable;" + ")Lrhino/Scriptable;");
		cfw.addAStore(variableObjectLocal);
	}
