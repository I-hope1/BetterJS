...
public class Codegen implements Evaluator {
    ...
    public Object compile(
        ...
        // Core.settings.getDataDirectory().child("tmp").child(mainClassName + ".class")
        //  .writeBytes(mainClassBytes);
    ...
    public Function createFunctionObject(
            Context cx, Scriptable scope, Object bytecode) {
        Class<?> cl = defineClass(bytecode);
    ...
    private void emitDirectConstructor(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        */
        ...
        cfw.add(ByteCode.INSTANCEOF, "rhino/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "rhino/Scriptable");
    ...
    private void generateMain(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                mainMethodClass,
                "main",
                "(Lrhino/Script;[Ljava/lang/String;)V");
    ...
    private void generateFunctionInit(ClassFileWriter cfw, OptFunctionNode ofn) {
        ...
        cfw.addInvoke(
                ...
                "initScriptFunction",
                "(Lrhino/Context;" + "Lrhino/Scriptable;" + ")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw) {
        ...
        cfw.addInvoke(
                ...
                "rhino/ScriptRuntime",
                "checkRegExpProxy",
                "(Lrhino/Context;" + ")Lrhino/RegExpProxy;");
    ...
    static final String DEFAULT_MAIN_METHOD_CLASS = "rhino.optimizer.OptRuntime";

    private static final String SUPER_CLASS_NAME = "rhino.NativeFunction";

    static final String ID_FIELD_NAME = "_id";

    static final String REGEXP_INIT_METHOD_NAME = "_reInit";
    static final String REGEXP_INIT_METHOD_SIGNATURE = "(Lrhino/Context;)V";
    ...
    static final String FUNCTION_CONSTRUCTOR_SIGNATURE =
            "(Lrhino/Scriptable;" + "Lrhino/Context;I)V";
