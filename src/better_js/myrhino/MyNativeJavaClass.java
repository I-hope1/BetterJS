...
public class MyNativeJavaClass extends MyNativeJavaObject implements Function {
	// Special property for getting the underlying Java class object.
	static final String javaClassPropertyName = "__javaObject__";

	public MyNativeJavaClass() {
	}

	public MyNativeJavaClass(Scriptable scope, Class<?> cl) {
		this(scope, cl, false);
	}

	public MyNativeJavaClass(Scriptable scope, Class<?> cl, boolean isAdapter) {
	...
	public void initMembers() {
		...
		members = MyJavaMembers.lookupClass(parent, cl, cl, isAdapter);
	...
	public Scriptable construct(Context cx, Scriptable scope, Object[] args) {
		...
		if (!(Modifier.isInterface(modifiers) ||
			...
			MyNativeJavaMethod ctors = members.ctors;
		...
		if (args.length == 0) {
			throw ExceptionReporter.reportRuntimeError0("msg.adapter.zero.args");
		}
		...
		try {
			...
			if ("Dalvik".equals(System.getProperty("java.vm.name"))
				...
				Object obj = NativeJavaObject.createInterfaceAdapter(classObject,
						ensureScriptableObject(args[0]));
	...
	static Object constructInternal(Object[] args, MyMemberBox ctor) {
	...
	public boolean hasInstance(Scriptable value) {
		...
		if (value instanceof Wrapper &&
				!(value instanceof MyNativeJavaClass)) {
